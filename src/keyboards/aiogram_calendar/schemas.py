...
class CalendarLabels(BaseModel):
    ...
    days_of_week: Annotated[list[str], Field(max_length=7, min_length=7)] = ["Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"] 
    # conlist(str, max_length=7, min_length=7) = ["Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"]
    months: Annotated[list[str], Field(max_length=12, min_length=12)] =  ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
    # conlist(str, max_length=12, min_length=12) = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
    cancel_caption: str = Field(default='Cancel', description='Caprion for Cancel button')
    today_caption: str = Field(default='Today', description='Caprion for Today button')
    tomorrow_caption: str = Field(default='Tomorrow', description='Caprion for Tomorrow button')
